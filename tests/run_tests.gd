...
func _run() -> void:
	...
	# This fixture was generated by running the actual foundation commit's SaveManager.
	file = FileAccess.open(saves.save_path, FileAccess.WRITE)
	file.store_string(FileAccess.get_file_as_string("res://tests/fixtures/foundation_v1.json"))
	file.close()
	loaded = saves.load_data()
